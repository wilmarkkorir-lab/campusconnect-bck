...
DATABASES = {
    'default': {
        ...
        'USER': 'campusconnect',
        'PASSWORD': 'modcom2026',
        'HOST': 'mysql-campusconnect.alwaysdata.net',
        'PORT': '3306',
        'OPTIONS': {
            'charset': 'utf8mb4',
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Complete University Student Digital Platform API',
    'VERSION': '1.0.0',
}
...
CORS_ALLOWED_ORIGINS = [
    ...
    'http://127.0.0.1:5173',
    'http://127.0.0.1:5174',
    'https://campusconnect.alwaysdata.net',
]
# Set to True temporarily during development — change to False in production
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='CampusConnect <noreply@campusconnect.com>')
